    ...
    <div className="comment" key={key}>
      ...
      <div className="info">
        <div className="author">
          <Link className="name" to={`/profile/${data.id}`}>
            {data.name}
          </Link>
          <span className="cohorteDate">
            {data.cohorte} · {data.date}
          </span>
        </div>
        ...
        <div className="likesComments">
          <div
            className="sizeLikes"
            onClick={() => setComment({ ...comment, liked: !comment.liked })}
          >
            {comment.liked ? (
            ...
            {data.countLikes && <p className="count">{data.countLikes}</p>}
          </div>
      ...
      <div className="options">
        <FaEllipsisH
          ...
          onClick={() => setComment({ ...comment, options: true })}
        />
        <div
